function [r] = ml_core_all_pixel_rotated_pixel_cross_correlation_90deg(T1, T2, varargin)
    p = inputParser;
    ...
    for k = 1:numRotations
        ...
        r(k) = ml_core_pixel_pixel_similarity_compute(T1, T2Rot, 'W1', p.Results.W1, 'W2', W2Rot);
    end
end % function
