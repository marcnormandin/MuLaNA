function [x_bounded, y_bounded, xedges, yedges, xi, yi, sxi, syi, ...
    ...
    meanFiringRateMapSmoothedPlot ] = ml_placefield_compute_all(x, y, ts_mus, si, boundsx, boundsy, nbinsx, nbinsy, kernelGaussianSize_bins, kernelGaussianSigma_cm)
    ...
    % Knock-out the unvisited bins by settings them to NAN
    ...
    meanFiringRateMapSmoothed = ml_placefield_meanfiringratemap_smoothbeforedivision(spikeCountMap, dwellTimeMap, kernel);
