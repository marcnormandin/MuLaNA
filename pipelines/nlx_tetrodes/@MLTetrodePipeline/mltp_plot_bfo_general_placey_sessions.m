function mltp_plot_bfo_general_placey_sessions(obj, rotDeg, group)
    numAngles = 360/rotDeg;
    angles = (0:numAngles-1)*rotDeg;
    
    % Load the data
    fn = fullfile(obj.Experiment.getAnalysisParentDirectory(), sprintf('bfo_%d_placey_%s_avg.mat', rotDeg, group));
    if ~isfile(fn)
...
%     %title('Average Correlation')
    ...
    prefix = sprintf('bfo_%d_placey_%s', rotDeg, group);
