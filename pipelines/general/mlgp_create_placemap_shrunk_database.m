function mlgp_create_placemap_shrunk_database(obj, session)
    fprintf('Creating placemap database (shrunk) for session %s\n', session.getName());
    ...
    for iTrial = 1:numTrials
        ...
        pmf = fullfile(taf, obj.Config.placemaps.outputFolderShrunk);
