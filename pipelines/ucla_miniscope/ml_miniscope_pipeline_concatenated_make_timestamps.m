...
function ml_miniscope_pipeline_concatenated_make_timestamps(session)
    scopeTimes = {};
    ...
    destTimestampFilename = fullfile(destVideoFolder, 'timestamp.dat');
    ...
    for iTime = 1:numTimesamples
        fprintf(fid, '%d\t%d\t%d\t%d', 0, iTime, scopeTimes(iTime), 1);
