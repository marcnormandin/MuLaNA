...
%     smoothingKernel = obj.SmoothingKernelSymmetric;
    ...
    % Load the trace maximums. Isabel said that she doesnt want this any
    % more.
...
%         use_scopeTrace(use_scopeTrace < traceThreshold) = 0;
    ...
    save(fullfile(outputFolder, 'climerICS_smoothed_shrunk.mat'), 'climerICS_smoothed');
    save(fullfile(outputFolder, 'climerICS_unsmoothed_shrunk.mat'), 'climerICS_unsmoothed');
