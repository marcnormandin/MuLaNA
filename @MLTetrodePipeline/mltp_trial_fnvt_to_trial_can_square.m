function mltp_trial_fnvt_to_trial_can_square(obj, session)
            ...
            for iTrial = 1:session.num_trials_recorded
                ...
                a = [obj.config.placemaps_square.bounds_x(2), obj.config.placemaps_square.bounds_y(1)];
                b = [obj.config.placemaps_square.bounds_x(1), obj.config.placemaps_square.bounds_y(1)];
                c = [obj.config.placemaps_square.bounds_x(1), obj.config.placemaps_square.bounds_y(2)];
                d = [obj.config.placemaps_square.bounds_x(2), obj.config.placemaps_square.bounds_y(2)];
